...
import { 
  ...
  Clock, MessageSquare, ChevronRight, Loader2, MessageCircle, Share2, ArrowRight
} from 'lucide-react'
...
function getWhatsAppUrl(num: string, storeName: string) {
  ...
  const text = encodeURIComponent(`Hello ${storeName}, I am contacting you from your website.`)
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800">
      ...
      <main className="flex-1 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Right: Direct Store Info, WhatsApp & Social Channels */}
